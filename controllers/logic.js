...
login=(req,res)=>{
 ...
 moneyTransfer=(req,res)=>{
  ...
  const {sAcno,rAcno,amount,spsw,date}=req.body
      // sAcno=sender account number
      // rAcno=receiver account number
      // spsw=sender password
